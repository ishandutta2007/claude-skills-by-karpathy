# 受 Karpathy 启发的 Claude Skills

> 查看我的新项目 [Multica](https://github.com/multica-ai/multica) —— 一个用于运行和管理编码智能体的开源平台，支持可复用的 **Claude Skills**。
>
...
## 解决方案：优质 Claude Skills

四个核心原则被封装为 **Claude Skills**，直接解决这些问题：

| Claude Skill 原则 | 解决什么问题 |
|-----------|-----------|
